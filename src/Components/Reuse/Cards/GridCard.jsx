...
const GridCard = ({property}) => {
   ...
   const makePayment = async()=>{
    ...
    return (
        <div className='font-jost  shadow-[#1e1d1dfa] rounded-lg bg-color_main_light'
           >
            <img src={property.images[0]} alt="" className='h-72 w-full rounded-t-lg' />
        <div className='p-4 text-text_main'>
       <div className='flex justify-between items-center'>
        <div> <p>{property.propertyStatus.listingIn}</p>
        <h2 className=' font-semibold text-xl'>{property.title}</h2></div>
        <div>
 ...
 <div className='flex items-center gap-2'>
        <div className='p-2 bg-color_main rounded-full'><IoBedOutline></IoBedOutline></div><p>{property.details.features.bedrooms} Beds</p></div>
        <div className='flex items-center gap-2'>
        <div className='p-2 bg-color_main rounded-full'><LuBath></LuBath></div><p>{property.details.features.bathrooms} Baths</p></div>
        <div className='flex items-center gap-2'>
        <div className='p-2 bg-color_main rounded-full'><TbArrowAutofitHeight></TbArrowAutofitHeight></div><p>{property.details.area} Sqft</p></div>
       </div>
